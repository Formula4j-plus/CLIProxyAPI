...
var zhStrings = map[string]string{
	...
	"auth_help3":         " [/] 筛选 • [x] 清除筛选 • [4] 删除401 • [f] 刷新账号",
	"no_auth_files":      "  无认证文件",
	...
	"status_active":      "活跃",
	"status_disabled":    "已停用",
	"filter_placeholder": " 筛选: 优先级/套餐/账号名 ",
	"filter_active":      " 筛选: %s",
	"filter_clear":       "已清除筛选",
	"delete_401":         "正在删除 401 文件...",
	"deleted_401":        "已删除 %d 个 401 文件",
	"refresh_account":    "正在刷新账号...",
	"refreshed_account":  "已刷新 %s",
	"plan":               "套餐",
...
var enStrings = map[string]string{
	...
	"auth_help3":         " [/] Filter • [x] Clear filter • [4] Delete 401 • [f] Refresh account",
	...
	"filter_placeholder": " Filter: priority/plan/account ",
	"filter_active":      " Filter: %s",
	"filter_clear":       "Filter cleared",
	"delete_401":         "Deleting 401 files...",
	"deleted_401":        "Deleted %d 401 files",
	"refresh_account":    "Refreshing account...",
	"refreshed_account":  "Refreshed %s",
	"plan":               "Plan",
